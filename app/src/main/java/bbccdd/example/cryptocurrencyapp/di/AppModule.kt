package bbccdd.example.cryptocurrencyapp.di

import bbccdd.example.cryptocurrencyapp.common.Constants
import bbccdd.example.cryptocurrencyapp.data.remote.CoinPaprikaApi
import bbccdd.example.cryptocurrencyapp.data.repository.CoinRepositoryImpl
